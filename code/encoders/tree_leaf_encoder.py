...
from .tree.leaf_encoder import LeafEncoder
...
class TreeLeafEncoder(LeafEncoder):
    @classmethod
    ...
    def _single_model(self, is_train: bool = False) -> tf.Tensor:
        ...
        with tf.variable_scope("tree_encoder"):
            ...
            if model == 'nbow':
                ...
                if attention:
                    seq_tokens_embeddings = Common.yet_attention_layer(seq_tokens_embeddings)
                ...
                if attention:
                    current_embeddings = Common.yet_attention_layer(current_embeddings)
                ...
                if attention:
                    token_embeddings = Common.yet_attention_layer(token_embeddings)
                ...
                if output_pool_mode == 'bert':
                    ...
                    if attention:
                        seq_token_embeddings = Common.yet_attention_layer(seq_token_embeddings)
