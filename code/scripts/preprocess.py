...
def save_dictionaries(dataset_name, subtoken_to_count, node_to_count, target_to_count, max_contexts):
...
if __name__ == '__main__':
    ...
    subtoken_to_count = load_histogram(subtoken_histogram_path, max_size=int(args.subtoken_vocab_size))
